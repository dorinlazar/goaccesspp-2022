...
build/gdns.o: src/gdns.cpp src/gkhash.h src/xmalloc.h src/util.h src/khash.h src/goaccess.h src/settings.h src/commons.h src/error.hpp src/color.h src/labels.h src/sort.h src/gslist.h src/ui.h src/gdns.h src/parser.h src/gstorage.h
...
build/geoip1.o: src/geoip1.cpp src/error.hpp src/commons.h src/geoip1.h src/gslist.h src/settings.h src/util.h
...
build/ui.o: src/ui.cpp src/error.hpp src/settings.h src/gkhash.h src/xmalloc.h src/util.h src/goaccess.h src/khash.h src/commons.h src/color.h src/labels.h src/sort.h src/gslist.h src/ui.h src/parser.h src/gmenu.h src/gstorage.h
...
build/goaccess.o: src/goaccess.cpp src/tpl.h src/opesys.h src/websocket/sha1.h src/websocket/base64.h src/resources/hoganjs.h src/resources/d3js.h src/resources/appjs.h src/resources/facss.h src/resources/appcss.h src/persistence.h src/gkhash.h src/resources/bootstrapcss.h src/settings.h src/error.hpp src/resources/chartsjs.h src/color.h src/ui.h src/gdashboard.h src/options.h src/commons.h src/websocket/gwsocket.h src/csv.h src/gholder.h src/gstorage.h src/opsys/osutils.hpp src/goaccess.h src/xmalloc.h src/output.h src/sort.h src/gslist.h src/resources/tpls.h src/labels.h src/geoip1.h src/json.h src/util.h src/websocket/websocket.h src/browsers.h src/parser.h src/gdns.h src/khash.h src/gmenu.h src/pdjson.h
	g++ -Wall -Wextra -c -std=c++20 -g3 -O2 -flto -Werror -o build/goaccess.o src/goaccess.cpp -Isrc -Isrc/opsys -Isrc/resources -Isrc/websocket -Isrc -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600
...
build/gstorage.o: src/gstorage.cpp src/geoip1.h src/browsers.h src/opesys.h src/error.hpp src/xmalloc.h src/util.h src/settings.h src/labels.h src/color.h src/commons.h src/gslist.h src/sort.h src/khash.h src/ui.h src/parser.h src/gstorage.h src/gkhash.h
...
build/gholder.o: src/gholder.cpp src/commons.h src/error.hpp src/geoip1.h src/xmalloc.h src/util.h src/settings.h src/khash.h src/gslist.h src/sort.h src/gholder.h src/gkhash.h src/gstorage.h src/parser.h src/gdns.h
...
build/goaccess.exe: build/pdjson.o build/gmenu.o build/websocket/gwsocket.o build/ui.o build/error.o build/xmalloc.o build/websocket/websocket.o build/gkhash.o build/gholder.o build/persistence.o build/json.o build/websocket/base64.o build/settings.o build/websocket/sha1.o build/tpl.o build/goaccess.o build/opesys.o build/opsys/osutils.o build/csv.o build/color.o build/output.o build/sort.o build/options.o build/gslist.o build/gstorage.o build/geoip1.o build/gdns.o build/util.o build/browsers.o build/gdashboard.o build/commons.o build/parser.o
	g++ -flto -Werror -ltcmalloc -o build/goaccess.exe build/pdjson.o build/gmenu.o build/websocket/gwsocket.o build/ui.o build/error.o build/xmalloc.o build/websocket/websocket.o build/gkhash.o build/gholder.o build/persistence.o build/json.o build/websocket/base64.o build/settings.o build/websocket/sha1.o build/tpl.o build/goaccess.o build/opesys.o build/opsys/osutils.o build/csv.o build/color.o build/output.o build/sort.o build/options.o build/gslist.o build/gstorage.o build/geoip1.o build/gdns.o build/util.o build/browsers.o build/gdashboard.o build/commons.o build/parser.o -lfmt -lGeoIP -lncurses -ltinfo -lssl -lcrypto
executables: build/bin2c.exe build/goaccess.exe
makedirs:
	mkdir -p build/opsys build/resources build/websocket build
