...
build/gdns.o: src/gdns.cpp src/gkhash.h src/xmalloc.h src/util.h src/khash.h src/goaccess.h src/commons.h src/error.hpp src/color.h src/labels.h src/sort.h src/gslist.h src/settings.h src/ui/ui.h src/gdns.h src/parser.h src/gstorage.h
...
build/parser.o: src/parser.cpp src/gkhash.h src/pdjson.h src/browsers.h src/xmalloc.h src/websocket/websocket.h src/commons.h src/error.hpp src/parser.h src/gstorage.h src/util.h src/khash.h src/goaccess.h src/gslist.h src/sort.h src/color.h src/labels.h src/settings.h src/ui/ui.h
...
build/gstorage.o: src/gstorage.cpp src/geo/geoip1.h src/color.h src/xmalloc.h src/util.h src/ui/ui.h src/settings.h src/khash.h src/sort.h src/gslist.h src/commons.h src/error.hpp src/gstorage.h src/parser.h src/gkhash.h src/opesys.h src/browsers.h src/labels.h
...
build/gdashboard.o: src/gdashboard.cpp src/gdashboard.h src/labels.h src/xmalloc.h src/util.h src/ui/ui.h src/settings.h src/commons.h src/error.hpp src/parser.h src/gstorage.h src/color.h src/gslist.h src/sort.h src/khash.h src/gholder.h src/gkhash.h
...
build/json.o: src/json.cpp src/json.h src/error.hpp src/gkhash.h src/xmalloc.h src/labels.h src/color.h src/websocket/websocket.h src/commons.h src/gslist.h src/sort.h src/khash.h src/util.h src/ui/ui.h src/settings.h src/parser.h src/gstorage.h
	g++ -Wall -Wextra -c -std=c++20 -g3 -O2 -flto -Werror -o build/json.o src/json.cpp -Isrc -Isrc/ui -Isrc/websocket -Isrc -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600
...
build/csv.o: src/csv.cpp src/csv.h src/util.h src/labels.h src/color.h src/commons.h src/error.hpp src/gslist.h src/sort.h src/khash.h src/settings.h src/ui/ui.h src/parser.h src/gstorage.h src/gkhash.h
...
build/websocket/gwsocket.o: src/websocket/gwsocket.cpp src/websocket/gwsocket.h src/xmalloc.h src/json.h src/parser.h src/websocket/websocket.h src/commons.h src/error.hpp src/goaccess.h src/gslist.h src/sort.h src/color.h src/labels.h src/settings.h src/ui/ui.h
...
build/ui/ui.o: src/ui/ui.cpp src/error.hpp src/gkhash.h src/xmalloc.h src/util.h src/goaccess.h src/khash.h src/commons.h src/color.h src/labels.h src/sort.h src/gslist.h src/settings.h src/ui/ui.h src/parser.h src/gmenu.h src/gstorage.h
...
build/goaccess.o: src/goaccess.cpp src/tpl.h src/websocket/sha1.h src/websocket/base64.h src/resources/hoganjs.h src/resources/chartsjs.h src/resources/bootstrapcss.h src/resources/d3js.h src/resources/appcss.h src/persistence.h src/settings.h src/color.h src/resources/tpls.h src/gdashboard.h src/websocket/websocket.h src/error.hpp src/opesys.h src/csv.h src/websocket/gwsocket.h src/util.h src/ui/ui.h src/khash.h src/options.h src/labels.h src/goaccess.h src/json.h src/opsys/osutils.hpp src/xmalloc.h src/browsers.h src/gkhash.h src/resources/facss.h src/gholder.h src/gstorage.h src/parser.h src/resources/appjs.h src/gdns.h src/output.h src/gslist.h src/sort.h src/geo/geoip1.h src/commons.h src/gmenu.h src/pdjson.h
	g++ -Wall -Wextra -c -std=c++20 -g3 -O2 -flto -Werror -o build/goaccess.o src/goaccess.cpp -Isrc -Isrc/geo -Isrc/opsys -Isrc/ui -Isrc/resources -Isrc/websocket -Isrc -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600
...
build/goaccess.exe: build/pdjson.o build/gmenu.o build/persistence.o build/json.o build/error.o build/xmalloc.o build/websocket/websocket.o build/websocket/gwsocket.o build/websocket/base64.o build/websocket/sha1.o build/tpl.o build/goaccess.o build/settings.o build/ui/ui.o build/opesys.o build/opsys/osutils.o build/gdns.o build/util.o build/browsers.o build/gkhash.o build/gholder.o build/gstorage.o build/commons.o build/gdashboard.o build/parser.o build/color.o build/csv.o build/output.o build/sort.o build/options.o build/gslist.o build/geo/geoip1.o
	g++ -flto -Werror -ltcmalloc -o build/goaccess.exe build/pdjson.o build/gmenu.o build/persistence.o build/json.o build/error.o build/xmalloc.o build/websocket/websocket.o build/websocket/gwsocket.o build/websocket/base64.o build/websocket/sha1.o build/tpl.o build/goaccess.o build/settings.o build/ui/ui.o build/opesys.o build/opsys/osutils.o build/gdns.o build/util.o build/browsers.o build/gkhash.o build/gholder.o build/gstorage.o build/commons.o build/gdashboard.o build/parser.o build/color.o build/csv.o build/output.o build/sort.o build/options.o build/gslist.o build/geo/geoip1.o -lfmt -lGeoIP -lncurses -ltinfo -lssl -lcrypto
executables: build/bin2c.exe build/goaccess.exe
makedirs:
	mkdir -p build/ui build/opsys build/websocket build/resources build/geo build
